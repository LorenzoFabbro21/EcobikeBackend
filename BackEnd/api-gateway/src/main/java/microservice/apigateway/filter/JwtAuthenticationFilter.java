...
public class JwtAuthenticationFilter implements GlobalFilter, Ordered {
	...
	private List<String> UriNotProtected = Arrays.asList("/api/adrent","/api/adrent/bikes", "/api/adsell","/api/adsell/bikes", "/api/bike/**","/api/bike", "/api/private/email/","/api/dealer/email/", "/auth/**" , "/api/shop",  "/api/shop/", "/api/adrent/user/{id}/bikes" , "/api/adsell/user/{id}/bikes", "/api/review/idShop/", "/api/private/{id}", "/api/appointment");
